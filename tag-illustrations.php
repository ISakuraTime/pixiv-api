 ...
 * lang zh
 * version b2d6f6256ccf3a9b62b0b55692d6ac3f980d53cb
 * -->
 */
$param = array();
// 获取用户ID
...
if (isset($sMode)) {
    ...
    $param["s_mode"] = "s_tag_full";
}

$illustAndUgoira = $_GET["illust_and_ugoira"];
if (isset($sMode)) {
    $param["type"] = $illustAndUgoira;
} else {
    $param["type"] = "illust_and_ugoira";
}
...
$imageUrl = "https://www.pixiv.net/ajax/search/illustrations/".urlencode($tagName);
