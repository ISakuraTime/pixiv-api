...
if (empty($ids)) {
    $errorJson = array();
    $errorJson["msg"] = "Please enter the illusts ids";
    $errorJson["code"] = 500;
    $errorJson["body"] = "";
...
if (isset($work_category)) {
    $param["work_category"] = $work_category;
} else {
    $param["work_category"] = "illust";
}

$is_first_page = $_GET["is_first_page"];
if (isset($is_first_page)) {
    $param["is_first_page"] = $is_first_page;
} else {
    $param["is_first_page"] = 1;
}
...
$imageUrl = "https://www.pixiv.net/ajax/user/$userId/profile/illusts";
